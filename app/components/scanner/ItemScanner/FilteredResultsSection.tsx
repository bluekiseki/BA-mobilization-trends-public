    ...
    <div>
          ...
          return (
            <button
              ...
              className={[
                'rounded px-2 py-0.5 text-xs font-medium transition-colors',
                active
                  ? 'bg-blue-100 dark:bg-blue-900/60 text-blue-700 dark:text-blue-200 hover:bg-blue-200 dark:hover:bg-blue-800/60 border border-blue-400/50 dark:border-blue-700/50'
            ...
            >
              ...
              <span className={`ml-1 ${active ? 'text-blue-600 dark:text-blue-400' : 'text-neutral-500 dark:text-neutral-600'}`}>{count}</span>
            </button>
          );
        })}
      </div>
      ...
      <div className="flex items-center gap-2 mb-3">
        <button
          ...
          className="flex items-center gap-1.5 bg-ba-btn-blue px-3 py-1.5 text-sm font-semibold text-neutral-900 transition-colors hover:bg-ba-btn-blue-dark disabled:cursor-not-allowed disabled:opacity-40"
        >
