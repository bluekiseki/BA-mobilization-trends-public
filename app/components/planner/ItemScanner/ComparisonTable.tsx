                  ...
                  <tr key={key} className="hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                    ...
                    <td className="px-2 py-1.5 text-right sm:px-3">
                      <input
                        ...
                        className="w-20 border border-neutral-300 dark:border-neutral-600 bg-white dark:bg-neutral-800 px-1.5 py-0.5 text-right text-neutral-800 dark:text-neutral-200 text-xs focus:border-sky-500 focus:outline-none"
                      />
                    </td>
                    <td
                      className={[
