...
import wasmInit, { gacha_run_chunk } from './gacha_engine_pkg.js';
...
self.onmessage = async (e: MessageEvent<WorkerInMsg>) => {
  try {
    ...
    const { grade3Ids, grade2Ids, grade1Ids, fesIds, fesExcludedIds, bannerPickupIds, pickupId, isFes, totalPullCount } = e.data;
    ...
    while (remaining > 0) {
      ...
      const wasmStats = gacha_run_chunk(g3, g2, g1, fes, fesExcl, pickupIds, pickupId, isFes, chunkCount, seed);
