...
//           <span className="text-gray-300 dark:text-gray-600">|</span>
//           <span>{difficultLevel}</span>

//           <span className="text-xs font-light opacity-80">{difficultLevel && raidInfo.Cnt[difficultLevel]?.toLocaleString()}</span>
//           <span className="text-gray-300 dark:text-gray-600">|</span>
//           <span>{raidInfo?.TotalParticipants?.toLocaleString()}</span>
//         </div>
...
//           {/* {Boss} */}
//           {bossNameData[Boss]?.[getLocaleShortName(locale)]}

//         </h3>
//         <time className="text-xs text-neutral-500 dark:text-neutral-400 mt-2" dateTime={date}>{date}</time>

//         {raidInfo.Platinum} - {raidInfo.Platinum && formatTimeToTimestamp(calculateTimeFromScore(raidInfo.Platinum, raidInfo.Boss, region, raidInfo.Id))}
//       </div>
//     </Link>
//   );
// }

// // ERaid (multiple bosses) card
...
//           <span className="text-gray-300 dark:text-gray-600">|</span>
//           <span>{primaryRaid?.TotalParticipants?.toLocaleString()}</span>
//         </div>
//         <h3 className="text-xl font-bold text-neutral-800 dark:text-neutral-200 mt-1 truncate">
//           <span className="text-xs font-light text-gray-400 mr-1 relative -top-1">S{id.substring(1)}</span>
//           {bossNameData[Boss]?.[getLocaleShortName(locale)]}
...
//           {raidInfos.map(raid => {
//             const difficultLevel = getMostDifficultLevel(raid)
//             return (
...
//               <span>{type_translation[raid.Type!][getLocaleShortName(locale)]}</span>
//               <span className="font-normal opacity-80 text-nowrap">{getMostDifficultLevel(raid)}</span>

//               <span className="text-[0.65rem] font-light opacity-80">{difficultLevel && raid.Cnt[difficultLevel]?.toLocaleString()}</span>
//             </div>
//           )})}
//         </div>
//         <time className="text-xs text-neutral-500 dark:text-neutral-400 mt-2" dateTime={date}>{date}</time>

//         {primaryRaid.Platinum} - {getBracketFromTotalScore(primaryRaid.Platinum)}
//       </div>
//     </Link>
//   );
// }
